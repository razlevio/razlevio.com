...
export function TestimonialsMarquee() {
  return (
    <Panel
      className="[&_.rfm-initial-child-container]:items-stretch! [&_.rfm-marquee]:items-stretch! before:z-11 after:z-10"
      id="testimonials"
    >
      ...
      <Marquee>
        ...
        <MarqueeContent>
          {TESTIMONIALS_1.slice()
            ...
            .map((item) => (
              <MarqueeItem
                className="mx-0 h-full w-xs border-edge border-r"
                key={item.url}
              >
